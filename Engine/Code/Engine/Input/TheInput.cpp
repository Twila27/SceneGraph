...
//--------------------------------------------------------------------------------------------------------------
void TheInput::SetMouseDownStatus( int unityStyleID, bool isNowDown )
{
	m_mouseButtons[ unityStyleID ].m_didMouseButtonJustChange = 
		( m_mouseButtons[ unityStyleID ].m_isMouseButtonDown != isNowDown ? true : false );
	m_mouseButtons[ unityStyleID ].m_isMouseButtonDown = isNowDown;
}
...
//--------------------------------------------------------------------------------------------------------------
bool TheInput::IsMouseButtonDown( int unityStyleID ) const
{
	return m_mouseButtons[ unityStyleID ].m_isMouseButtonDown;
}


//--------------------------------------------------------------------------------------------------------------
bool TheInput::WasMouseButtonJustPressed( int unityStyleID ) const
{
	return m_mouseButtons[ unityStyleID ].m_didMouseButtonJustChange;
}


//--------------------------------------------------------------------------------------------------------------
bool TheInput::WasMouseButtonPressedOnce( int unityStyleID )
{
	bool retval = m_mouseButtons[ unityStyleID ].m_didMouseButtonJustChange 
		&& m_mouseButtons[ unityStyleID ].m_isMouseButtonDown;

	//First come first serve, because WM_LBUTTONDOWN is proving slower than my block breaks!

	m_mouseButtons[ unityStyleID ].m_didMouseButtonJustChange = false;
